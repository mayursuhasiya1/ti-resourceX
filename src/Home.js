...
const Home = () => {
 ...
 <div class="justify-center ">
    <div class="flex items-center justify-between h-12 text-white bg-gray-400 shadow-md sm:h-20">     
        ...
        <h1 className="heading ml-4 text-lg text-black font-bold ml- sm:text-4xl mr-24">TI-ResourceX</h1>
        ...
        <div id='scroll-container' className='bg-black mb-14'>
           <p className="text-center text-lg text-white" id='scroll-text'>Your One Stop Employee Management</p>
        </div>
...
<footer class=" mt-14 text-center lg:text-left bg-black text-gray-600 ">
